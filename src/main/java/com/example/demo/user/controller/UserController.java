...
public class UserController {
    ...
    public ResponseEntity<MyProfileResponse> getMyInfo(
        ...
        User userEntity = userReadService.getByEmail(email);
        authenticationService.login(userEntity.getId());
        userEntity = userReadService.getByEmail(email);
        return ResponseEntity
            .ok()
            .body(MyProfileResponse.from(userEntity));
    }
    ...
    public ResponseEntity<MyProfileResponse> updateMyInfo(
        ...
        User userEntity = userReadService.getByEmail(email);
        userEntity = userUpdateService.update(userEntity.getId(), userUpdate);
        return ResponseEntity
            .ok()
            .body(MyProfileResponse.from(userEntity));
    }
