...
class UserJpaRepositoryTest {
    ...
    void findByEmailAndStatus_로_유저데이터를_찾아올_수_있다() throws Exception{
        ...
        Optional<UserEntity> result = userJpaRepository.findByEmailAndStatus("mw310@naver.com", UserStatus.ACTIVE);
    ...
    void findByEmailAndStatus는_데이터가_없으면_Optional_empty_를_내려준다() throws Exception{
        ...
        Optional<UserEntity> result = userJpaRepository.findByEmailAndStatus("mw310@naver.com", UserStatus.PENDING);
